...
> = {
  ...
  politica_alojamento: {
    ...
    corpo: [
      ...
      "Atividade Elaborar e revisar esta política Comunicar regras ao empregado na admissão Colher assinatura do Termo de Compromisso Entrega e devolução de chaves do alojamento e do armário Operar o sistema de câmeras (CFTV) Fiscalizar o cumprimento das regras no dia a dia Registrar ocorrências e advertências Aplicar penalidades disciplinares Manter limpeza coletiva e organização Comunicar problemas estruturais (manutenção) Cumprir as regras do alojamento Apurar denúncias",
      "Encarregad SESMT/ Empregado",
      "Detalhamento Recursos Humanos (RH)",
      "Elaborar, revisar e atualizar esta política.",
      "Comunicar as regras ao empregado na admissão e colher a assinatura do Termo de Compromisso.",
      "Aplicar advertências, suspensões e demais penalidades disciplinares previstas nesta política.",
      "Apurar denúncias e mediar conflitos quando não solucionados pelo Encarregado.",
      "Manter o arquivo das ocorrências e penalidades.",
      "Coordenar a gestão do CFTV (acesso, retenção, atendimento a pedidos de titulares). Encarregado de Obra / Administrativo do Contrato",
      "Fiscalizar diariamente o cumprimento das regras.",
      "— Registrar ocorrências (em livro próprio ou sistema indicado pela empresa).",
      "— Realizar entrega e devolução de chaves do alojamento e do armário individual.",
      "— Receber e dar primeira tratativa às demandas dos alojados.",
      "— Acionar o RH em caso de infração grave ou reincidência.",
      "— Coordenar a manutenção corretiva e preventiva do alojamento. Empregado / Alojado",
      "— Conhecer e cumprir esta política, assinando o Termo de Compromisso na admissão.",
      "— Zelar pela limpeza, segurança e conservação do alojamento e do armário individual.",
      "— Comunicar imediatamente problemas, danos ou violações.",
      ...
      "A tabela abaixo é orientativa e não exaustiva. A penalidade efetiva considera o caso concreto, atenuantes e agravantes, e é aplicada após análise pelo RH.",
      "1 Não manter a organização do quarto / pertences fora do lugar",
      "Advertência escrita na reincidência (em até 30 dias)",
      "2 Deixar louça suja ou restos de comida na cozinha/refeitório",
      "Advertência escrita na reincidência",
      "3 Descumprir horário de silêncio (22h às 06h)",
      "Advertência verbal na 1ª ocorrência",
      "Advertência escrita na 2ª; suspensão de 1 dia na 3ª",
      "4 Uso de caixa de som no alojamento",
      "Advertência escrita direta",
      "Suspensão de 1 dia na reincidência",
      "5 Permitir entrada de pessoa não autorizada no Advertência escrita",
      "Suspensão de 1 a 3 dias na reincidência",
      "6 Receber visita íntima no alojamento",
      "Suspensão imediata de 3 dias",
      "Justa causa na reincidência",
      "7 Consumir, portar ou armazenar bebida alcoólica no alojamento",
      "Suspensão imediata de 1 a 3 dias",
      "Justa causa na reincidência",
      "# Infração 8 Fumar fora da área designada 9 Cozinhar no alojamento ou usar eletrodoméstico não autorizado (fogão, air fryer, forno elétrico, etc.) 10 Danificar bem do alojamento (móvel, eletrodoméstico, instalação) 11 Embriaguez no alojamento ou no trabalho 12 Porte, uso ou tráfico de drogas ilícitas 13 Agressão física ou verbal a colega, encarregado ou visitante 14 Furto, apropriação indébita ou improbidade 15 Adulterar ou inutilizar câmeras, lacres ou dispositivos de segurança",
      "1ª ocorrência Advertência verbal Advertência escrita direta Advertência escrita + reposição do dano Suspensão imediata Justa causa imediata Suspensão imediata Justa causa imediata Suspensão imediata de 3 dias",
      "Reincidência Advertência escrita na reincidência; suspensão de 1 dia na 3ª Suspensão de 1 a 3 dias na reincidência (risco de incêndio) Suspensão e ressarcimento; justa causa se intencional Justa causa na reincidência (CLT, art. 482, \"f\") Comunicação às autoridades competentes Justa causa por indisciplina/insubordi nação Comunicação às autoridades competentes Justa causa na reincidência",
      "11.4. REINCIDÊNCIA",
      ...
      "____________________________________ Responsável — Recursos Humanos Nome: Cargo: Data: ____/____/______",
      "____________________________________ Diretoria Nome: Cargo: Data: ____/____/______",
    ].join("\n\n"),
  },
};
