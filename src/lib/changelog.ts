...
export const CHANGELOG: Release[] = [
  ...
  },
  {
    versao: "0.116.1",
    data: "2026-09-17",
    titulo: "A tela de entrada volta a ser clara",
    mudancas: [
      {
        tipo: "correcao",
        texto:
          "Para quem usa o computador em modo escuro, a tela de entrada aparecia escura, com o subtítulo e o rodapé quase ilegíveis. Ela volta a ser clara para todo mundo, como foi desenhada.",
      },
    ],
  },
  {
  ...
  },
  {
    versao: "0.114.0",
    data: "2026-09-16",
    titulo: "A devolução deixa de apontar para o termo da entrega",
    mudancas: [
      {
        tipo: "correcao",
        texto:
          "Devolver uma peça não amarra mais a posse dela no almoxarifado ao termo que estava sendo encerrado, o que deixava o termo marcado como encerrado com a posse ainda aberta.",
      },
    ],
  },
  {
  ...
  },
  {
    versao: "0.111.1",
    data: "2026-09-11",
    titulo: "Contratos do ERP na tela do contrato",
    mudancas: [
      {
        tipo: "novo",
        texto:
          "A tela do contrato mostra os contratos que o Mega tem com aquele fornecedor naquela obra: quanto foi contratado, quanto já foi medido e quanto sobra de saldo.",
      },
    ],
  },
  {
  ...
  },
  {
    versao: "0.109.0",
    data: "2026-09-11",
    titulo: "Imobiliária que recebe por vários imóveis",
    mudancas: [
      {
        tipo: "correcao",
        texto:
          "Quando o mesmo locador recebe o aluguel de vários imóveis, a seção “No Mega” agora avisa e mostra por quantos ele recebe — antes os títulos de todos iam parar num imóvel só.",
      },
    ],
  },
  {
    ...
    mudancas: [
      {
        tipo: "novo",
        texto:
          "Na tela do contrato, a seção “No Mega” mostra os títulos a pagar do fornecedor no ERP: o que já foi pago, o que segue em aberto e quando o dado foi copiado.",
      },
      {
        tipo: "novo",
        texto:
  ...
  },
  {
    ...
    mudancas: [
      ...
      { tipo: "melhoria", texto: "Três regras de permissão antigas reavaliavam a sessão a cada linha examinada, em vez de uma vez por consulta. Afetava toda tela que mostra o nome de quem fez alguma coisa." },
  ...
  },
  {
    ...
    mudancas: [
      ...
      { tipo: "seguranca", texto: "As funções que NÃO podem ser fechadas ganharam uma trava automática: se alguém tentar “limpar o apontamento do relatório” numa migration futura, os testes reprovam explicando o que aquilo quebraria." },
  ...
  },
  {
    versao: "0.81.1",
    data: "2026-09-06",
    titulo: "Placa e chassi, no cadastro do veículo",
    mudancas: [
      { tipo: "melhoria", texto: "No cadastro de um veículo, os campos passam a se chamar Placa e Chassi. São as mesmas colunas de patrimônio e número de série — mas ninguém que cadastra um carro procura o campo “número de série”." },
    ],
  },
  {
    versao: "0.81.0",
